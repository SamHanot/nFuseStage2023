...
wget https://binaries.sonarsource.com/Distribution/sonarqube/sonarqube-10.1.0.73491.zip #link nog aanpassen
mv sonarqube-10.1.0.73491.zip /opt/ #nog aanpassen
cd /opt/
unzip sonarqube-10.1.0.73491.zip #nog aanpassen
sudo mv sonarqube-10.1.0.73491 sonarqube #nog aanpassen
...
sonar.jdbc.url=jdbc:postgresql://sonarqube-instance-1.c2b2r28b1tfo.eu-west-1.rds.amazonaws.com:5432/postgres
